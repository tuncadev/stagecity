jQuery(document).ready(function (n) {
	var t = civi_company_review_vars.ajax_url;
	var a = n(".company-review-details");
	...
	n("body").on("click", ".form-reply .civi-submit-company-reply", function (e) {
		e.preventDefault();
		var a = n(this);
	...
	n(".reviewForm").validate({
		...
		submitHandler: function (e) {
			var a = n(".reviewForm").find(".civi-submit-company-rating");
			var r = n(".reviewForm");
			var i = false;
			if (window.FormData) {
				i = new FormData(r[0]);
