<?php /* Template: Top Search Filter  */ 

	wp_enqueue_style( 'um-talenthunt', get_template_directory_uri() . '/ultimate-member/assets/css/um-kaya-talenthunt.css',false,'1.1','all');
	wp_enqueue_script( 'talenthunt-um-js', get_theme_file_uri( '/ultimate-member/assets/js/kaya-um-custom.js' ), array('jquery'), '', true );
