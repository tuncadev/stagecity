...
add_action('delete_attachment', 'talenthunt_kaya_delete_resized_images');
if( !function_exists('talenthunt_kaya_image_resize') ){
function talenthunt_kaya_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {
  ...
  $common = talenthunt_kaya_common_info($url, $width, $height, $crop, $align, $retina);  
...
if(  !function_exists('talenthunt_kaya_common_info') ){
function talenthunt_kaya_common_info($url, $width, $height, $crop, $align, $retina) {
  ...
  if (preg_match('/\/[0-9]{4}\/[0-9]{2}\/.+$/', $urlinfo['path'], $matches)) {
    ...
    $file_path = ABSPATH . str_replace(get_parent_theme_file_path(), '', strstr($pathinfo['path'], $uploads_dir));
...
if( !function_exists('  ') ){
function talenthunt_kaya_delete_resized_images($post_id) {
