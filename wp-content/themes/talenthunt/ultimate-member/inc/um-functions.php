<?php
/*---------------------------------------------------------------------------------------
 UM Addon scripts and styles.
---------------------------------------------------------------------------------------*/

function prefix_add_footer_styles() {
	   wp_enqueue_style( 'kaya-um-css', get_template_directory_uri() . '/ultimate-member/templates/theme-style/um-kaya-talenthunt.css',false,'1.2','all');
		wp_enqueue_script( 'kaya-um-js', get_theme_file_uri( '/ultimate-member/assets/js/kaya-um-custom.js' ), array('jquery'), '', true );

	};
	add_action( 'get_footer', 'prefix_add_footer_styles' );

	include_once get_template_directory() . '/ultimate-member/inc/um_extension_media_admin.php';
...
if( function_exists( 'Kirki' ) ) {
	...
	include_once get_template_directory() . '/ultimate-member/templates/theme-style/um-customizer-kirki.php';
...
/*---------------------------------------------------------------------------------------
 UM Addon scripts and styles End
---------------------------------------------------------------------------------------*/
?>
