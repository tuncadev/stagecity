...
<div class="preload"><img src="http://i.imgur.com/KUJoe.gif" width="30px" height="30px"></div>
<?php if ( ! defined( 'ABSPATH' ) ) exit; ?>

 <?php $value = get_theme_mod( 'disable_kaya_custom_profile_tabs', true ); ?>
<div class="um <?php echo esc_attr( $this->get_class( $mode ) ); ?> um-<?php echo esc_attr( $form_id ); ?> um-role-<?php echo esc_attr( um_user( 'role' ) ); ?> 
<?php echo ( $value ) ? 'kaya-um-tabs-on' : 'kaya-um-tabs-off' ?>">
