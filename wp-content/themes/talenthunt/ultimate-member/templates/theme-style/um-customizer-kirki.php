...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'main_profile_body_content_bg_color',
  'label'       => __( 'Profile Main Body Content Box Background Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#f9f9f9',
  'transport'   => 'auto',
  'output'      => array(
...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'profile_content_rows_bg_color',
  'label'       => __( 'Profile Row Background Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#ffffff',
  'transport'   => 'auto',
  'output'      => array(
...
Kirki::add_field( 'theme_config_id', [
  'type'        => 'checkbox',
  'settings'    => 'disable_kaya_custom_profile_tabs',
  'label'       => esc_html__( 'Enable The Custom Profile Tabs', 'kirki' ),
 // 'description' => esc_html__( 'Description', 'kirki' ),
  'section'     => 'member_profile_page_section',
  'default'     => true,
] );
...
Kirki::add_field( 'kirki_theme_config', [
  ...
  'output'      => array(
        array(
          'element'  => '
          .um-profile-nav-item a, .um-row-heading 
          ',
          'property' => 'color',
          'suffix' => ' !important',
        ),
...
Kirki::add_field( 'kirki_theme_config', [
  ...
  'output'      => array(
        array(
          ...
          .um .um-profile-nav-item.active a:hover,  .kaya-um-tabs-wrap .kaya_pt_active 
          ',
          'property' => 'background-color',
          'suffix' => ' !important',
        ),
...
Kirki::add_field( 'kirki_theme_config', [
  ...
  'output'      => array(
        array(
          'element'  => '
          .um .um-profile-nav-item.active a,
          .um .um-profile-nav-item.active a:hover a, .kaya-um-tabs-wrap .kaya_pt_active 
          ',
          'property' => 'color',
          'suffix' => ' !important',
        ),
...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'profile_custom-row_heading_bg_color',
  'label'       => __( 'Custom Kaya Row Heading Border Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#f9f9f9',
  'transport'   => 'auto',
  'output'      => array(
...
Kirki::add_field( 'kirki_theme_config', [
  'type'        => 'color',
  'settings'    => 'profile_custom-row_heading_txt_color',
  'label'       => __( 'Custom Kaya Row Heading Text Color', 'kirki' ), 
  'section'     => 'member_profile_page_section',
  'default'     => '#333333',
  'transport'   => 'auto',
  'output'      => array(
...
div#send_users span#sendmail_members, .customemediauploader, .talent-btn, .wpcf7-submit
          ',
          'property' => 'background-color',
          'suffix' => ' !important',
        ), 
